<template>
  <button type="button" class="robin-button">
    <svg
      width="20"
      height="20"
      viewBox="0 0 20 20"
    ...
    >
      <g clip-path="url(#clip0)">
        ...
        />
        <path
          d="M10.0003 14.1667C11.8413 14.1667 13.3337 12.6743 13.3337 10.8333C13.3337 8.99238 11.8413 7.5 10.0003 7.5C8.15938 7.5 6.66699 8.99238 6.66699 10.8333C6.66699 12.6743 8.15938 14.1667 10.0003 14.1667Z"
          stroke="#476BD2"
          stroke-width="2"
          stroke-linecap="round"
          stroke-linejoin="round"
